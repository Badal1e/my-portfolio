...
export default function Home() {
  ...
  const projects = [
    ...
    // },
    {
      ...
      technologies: ["HTML", "CSS", "JavaScript"],
      image: "/se.jpg?height=300&width=500",
      link: "https://github.com/Badal1e/studyfest",
      github: "https://github.com/badal1e",
    },
    {
      title: "TechXpert",
  ...
  const certifications = [
    {
      ...
      issuer: "NPTEL",
      date: "2023",
      image: "/nptel.jpeg?height=100&width=100",
      link: "https://archive.nptel.ac.in/content/noc/NOC24/SEM2/Ecertificates/106/noc24-cs118/Course/NPTEL24CS118S157020067804430693.pdf",
    },
    {
      title: "JavaScript Algorithms and Data Structures",
      issuer: "freeCodeCamp",
      date: "2022",
      image: "/lpu.jpeg?height=100&width=100",
      link: "https://files.lpu.in/umsweb/skilldevcourse/SkillDevelopmentCertificates/12222800_453_08-24-2024.pdf",
    },
    {
      title: "Server side JavaScript with Node.js",
      issuer: "Coursera",
      date: "2022",
      image: "/coursera.jpeg?height=100&width=100",
      link: "https://www.coursera.org/account/accomplishments/verify/NC9H6NC3UCK9?utm_source=mobile&utm_medium=certificate&utm_content=cert_image&utm_campaign=sharing_cta&utm_product=course",
    },
  ]
  ...
  const programmingProfiles = [
    {
      ...
      problems: "400+",
      link: "https://leetcode.com/u/badal21/",
      icon: "/lc.png?height=50&width=50",
    },
    {
      platform: "CodeChef",
      username: "badal21",
    ...
    },
    {
      ...
      username: "binarysoqgb9",
      rating: "Specialist",
      contests: "15+",
      link: "https://www.geeksforgeeks.org/user/binarysoqgb9/",
      icon: "/gfg.jpeg?height=50&width=50",
    },
  ]
  ...
  const hackathons = [
    ...
    },
    {
      ...
      description: "Created an algorithm to optimize railway seat allocation for maximum passenger satisfaction.",
      image: "/codefest.jpg?height=200&width=300",
    },
    {
      name: "WEB-A-ARENA",
      date: "July 2022",
      project: "Express Learning API",
      achievement: "Best Backend Solution",
      description: "Built a robust API using Express.js to serve educational content to various platforms.",
      image: "/arena.jpeg?height=200&width=300",
    },
  ]
        ...
        <section id="home" className="min-h-screen flex flex-col justify-center items-center py-20">
          ...
          >
            <div className="relative mb-8 inline-block">
              ...
              >
                <Image
                  src="/badal.png?height=400&width=400"
                  alt="Profile"
                  width={400}
                  height={400}
            ...
            <NeonText text="Badal Kumar" className="text-5xl md:text-7xl font-bold mb-4" color="cyan" />
            ...
            >
              Creating innovative web experiences with clean code and captivating designs. Passionate about building
            ...
            >
              ...
              <motion.a
                href="https://www.linkedin.com/in/badalk1/"
                target="_blank"
                rel="noopener noreferrer"
                whileHover={{ y: -5, scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
              ...
              <motion.a
                href="mailto:rajbaadal63@gmail.com"
                whileHover={{ y: -5, scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                className="text-gray-400 hover:text-cyan-400 transition-colors"
              >
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              ...
              >
                <div className="relative">
                  <div className="relative z-10 rounded-lg overflow-hidden border-2 border-cyan-500">
                    <Image
                      src="/b2.jpg?height=600&width=500"
                      alt="About Me"
                      width={500}
                      height={600}
                      className="object-cover"
              ...
              >
                ...
                <p className="text-gray-300 mb-4">
                  I'm Badal Kumar, a passionate web developer and coding enthusiast. I love learning new technologies
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div>
                    ...
                    <p className="text-gray-300">Badal Kumar</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-cyan-400 mb-2">Email:</h4>
                    <p className="text-gray-300">rajbaadal63@gmail.com</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-cyan-400 mb-2">GitHub:</h4>
                    <p className="text-gray-300">Badal1e</p>
                  </div>
                  <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">badal.12222800@lpu.in</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">https://github.com/badal1e</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">https://www.linkedin.com/in/badalk1/</p>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <div className="space-y-6">
                  <div className="relative pl-8 pb-6 border-l border-gray-700">
                    ...
                    <p className="text-purple-400 mb-2">University of Technology | 2019 - 2023</p>
                    <p className="text-gray-300 text-sm">
                  ...
                  <div className="relative pl-8 pb-6 border-l border-gray-700">
                    ...
                    <p className="text-cyan-400 mb-2">City High School | 2017 - 2019</p>
                    <p className="text-gray-300 text-sm">
